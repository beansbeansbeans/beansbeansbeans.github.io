  ...
  var som = {
    ...
    initialize: function() {
      var data = {
        ...
        caption: "",
        description: "<a class='cta-main' href='http://collectivedebate.mit.edu/results/moralitymap' target='_blank'>View project</a><p>In this visualization users see how a self organizing map learns in real time to project patterns from a high-dimensional space onto a two-dimensional lattice of neurons. The training data comes from ~4k users’ moral matrices collected through the Collective Debate site. A moral matrix consists of five numbers that indicate how much importance a user assigns to the five moral foundations (harm, purity, fairness, authority, ingroup, and purity, as identified by the psychologist Jonathan Haidt) when assessing right and wrong. After the map has finished training it inflates with data to reveal a three-dimensional histogram of where users fall in the moral landscape. The visualization enables users to see how their own moral matrix compares to those of the prototypical liberal and conservative, as well as to the moral matrices of users who either supported or opposed the claim that differences in professional outcomes between men and women are primarily the product of socialization. </p><br/><div class='section-header'>Technology</div><p>The latice is visualized with WebGL. The computations for the self-organizing map are carried out on GPU shaders.</p>"
      };
