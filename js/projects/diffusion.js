  ...
  var diffusion = {
    ...
    initialize: function() {
      var data = {
        ...
        projectContents: '<a href="http://fab.cba.mit.edu/classes/MAS.864/people/annyuan/project.html" target="_blank" class="chrome"><div class="chrome-controls"><div class="close"></div><div class="min"></div><div class="max"></div></div><div class="contents"><video src="/video/diffusion.mp4"></video></div></a>',
        ...
        description: "<a class='cta-main' href='http://fab.cba.mit.edu/classes/MAS.864/people/annyuan/project.html' target='_blank'>View project</a><p class='quote'><em>One sign that you’re capable of constructive self-criticism is that you’re not dumbfounded by the question: What would it take to convince you you’re wrong? If you can’t answer that question you can take that as a warning sign.</em><span>— Philip Tetlock</span></p><p><a href='http://fab.cba.mit.edu/classes/MAS.864/people/annyuan/project.html' target='_blank'>What Would It Take</a> (diffusion) encourages users to consider beliefs that contradict their own. Specifically, the site asks users to articulate what it would take to change their mind on hot button issues like gun control and climate change, where their beliefs may be grounded in emotion.</p><p>Sometimes a user will be able to articulate mind-changing evidence - for example, a user may believe stricter gun laws would not reduce mass shootings, but he may also acknowledge that he would change his mind if shown evidence that criminals would obey gun laws. Thus, diffusion shows the user a way for him to consider the opposing belief - that stricter gun laws <em>would</em> reduce mass shootings.</p><p>Other times, a user will not be able to articulate any evidence that would change his mind. diffusion may then prompt the uncomfortable realization that his belief cannot be refuted because it is based on emotion, not evidence. </p><br/><div class='section-header'>Technology</div><p>diffusion is built with <a target='_blank' href='https://github.com/Matt-Esch/virtual-dom'>virtual dom</a>, <a target='_blank' href='http://d3js.org/'>d3</a>, <a target='_blank' href='https://nodejs.org/en/'>Node</a>, and <a target='_blank' href='https://mongodb.com'>MongoDB</a>.</p>"
      };
