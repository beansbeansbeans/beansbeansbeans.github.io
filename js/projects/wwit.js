  ...
  var wwit = {
    ...
    initialize: function() {
      var data = {
        ...
        description: "<a class='cta-main' href='http://whatwouldittake.cc' target='_blank'>View project</a><p><a href='http://whatwouldittake.cc' target='_blank'>What Would It Take</a> (WWIT) encourages users to consider beliefs that contradict their own by asking them to describe what it would take to change their mind on hot button issues like gun control and climate change. Specifically, WWIT asks a user to articulate what evidence could change his mind on an issue.</p><p>Sometimes a user will be able to articulate mind-changing evidence - for example, a user may believe stricter gun laws would not reduce mass shootings, but he may also acknowledge that he would change his mind if shown evidence that criminals would obey gun laws. Thus, WWIT gives the user a way to consider opposing beliefs.</p><p>Other times, a user will not be able to articulate any evidence that would change his mind. WWIT may then prompt the uncomfortable realization that his belief cannot be refuted because it is based on emotion, not evidence. </p><br/><div class='section-header'>Technology</div><p>WWIT is built with <a target='_blank' href='https://github.com/Matt-Esch/virtual-dom'>virtual dom</a>, <a target='_blank' href='http://d3js.org/'>d3</a>, <a target='_blank' href='https://nodejs.org/en/'>Node</a>, and <a target='_blank' href='https://mongodb.com'>MongoDB</a>.</p>"
      };
