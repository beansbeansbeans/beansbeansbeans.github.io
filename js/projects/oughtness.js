  ...
  var oughtness = {
    ...
    initialize: function() {
      var data = {
        ...
        projectContents: '<a href="https://oughtness.cc" target="_blank" class="chrome"><div class="chrome-controls"><div class="close"></div><div class="min"></div><div class="max"></div></div><div class="contents"><video src="/video/oughtness.mp4"></video></div></a>',
